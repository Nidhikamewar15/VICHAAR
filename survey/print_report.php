		...
		<div class="col-md-12">
			<div class="card card-outline card-success">
				...
				<div class="card-body ui-sortable">
					<?php 
					$question = $conn->query("SELECT * FROM questions where survey_id = $id and type !='textfield_s'");
							...
							<?php foreach(json_decode($row['frm_option']) as $k => $v): 
								...
								<li>
									...
									<div class="progress w-100" >
					                  <div class="progress-bar bg-success progress-bar-striped" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $prog ?>%">
